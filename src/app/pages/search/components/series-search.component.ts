...
export class SeriesSearchComponent extends CommonSearchComponent {
  ...
  getResults() {
    this.submitLoading = true;
      ...
      //console.log(arr);
      this.searchService.seriesSearch(this.authenticationService.sessionId, {Query: this.searchQuery, Page: this.searchPage})
      .pipe(
      ...
      this.searchService.seriesSearchCount(this.authenticationService.sessionId, this.searchQuery)
      .pipe(
        finalize(() => this.submitLoading = false)
      )
      .subscribe(
