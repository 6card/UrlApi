...
export class SectionSearchComponent extends CommonSearchComponent {
  ...
  getResults() {
    this.submitLoading = true;
      ...
      //console.log(arr);
      this.searchService.sectionSearch(this.authenticationService.sessionId, {Query: this.searchQuery, Page: this.searchPage})
      .pipe(
      ...
      this.searchService.sectionSearchCount(this.authenticationService.sessionId, this.searchQuery)
      .pipe(
        finalize(() => this.submitLoading = false)
      )
      .subscribe(
